<?php
    ...
    function getMappingJSON($ontology, $ontology2) {
        if ($ontology && $ontology2) {
            try {
                if (file_exists("../ontology_cache/{$ontology}_{$ontology2}_mapping.json")) {
                    return json_decode(file_get_contents("../ontology_cache/{$ontology}_{$ontology2}_mapping.json"), $assoc=true);
                } else if (file_exists("../ontology_cache/{$ontology2}_{$ontology}_mapping.json")) {
                    return json_decode(file_get_contents("../ontology_cache/{$ontology2}_{$ontology}_mapping.json"), $assoc=true);
                }
            } catch (Exception $ex) {
